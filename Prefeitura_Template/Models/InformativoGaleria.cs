...
{
    [Table("InformativoGaleria")]
    public class InformativoGaleria : EntidadePadrao
    {
        ...
        public string CaminhoMidia
        {
            get
            {
                ...
                {
                    return HttpContext.Current.Server.MapPath(Utils.RetornaDiretorioInformativo()) + Midia;
                }
            }
        }
        ...
        public string CaminhoLogicoMidia
        {
            get
            {
                ...
                {
                    return "http://" + HttpContext.Current.Request.Url.Authority + Utils.RetornaDiretorioInformativo() + Midia;
                }
            }
        }
