...
{
    [Table("LicitacaoArquivo")]
    public class LicitacaoArquivo : EntidadePadrao
    {
        ...
        public string CaminhoArquivo
        {
            get
            {
                ...
                {
                    return HttpContext.Current.Server.MapPath(Utils.RetornaDiretorioLicitacao()) + Arquivo;
                }
            }
        }
        ...
        public string CaminhoLogicoArquivo
        {
            get
            {
                ...
                {
                    return "http://" + HttpContext.Current.Request.Url.Authority + Utils.RetornaDiretorioLicitacao() + Arquivo;
                }
            }
        }
