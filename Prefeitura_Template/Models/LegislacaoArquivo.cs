...
{
    [Table("LegislacaoArquivo")]
    public class LegislacaoArquivo : EntidadePadrao
    {
        ...
        public string CaminhoArquivo
        {
            get
            {
                ...
                {
                    return HttpContext.Current.Server.MapPath(Utils.RetornaDiretorioLegislacao()) + Arquivo;
                }
            }
        }
        ...
        public string CaminhoLogicoArquivo
        {
            get
            {
                ...
                {
                    return "http://" + HttpContext.Current.Request.Url.Authority + Utils.RetornaDiretorioLegislacao() + Arquivo;
                }
            }
        }
