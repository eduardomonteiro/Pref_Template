...
{
    [Table("ServicoArquivo")]
    public class ServicoArquivo : EntidadePadrao
    {
        ...
        public string CaminhoArquivo
        {
            get
            {
                ...
                {
                    return HttpContext.Current.Server.MapPath(Utils.RetornaDiretorioServico()) + Arquivo;
                }
            }
        }
        ...
        public string CaminhoLogicoArquivo
        {
            get
            {
                ...
                {
                    return "http://" + HttpContext.Current.Request.Url.Authority + Utils.RetornaDiretorioServico() + Arquivo;
                }
            }
        }
